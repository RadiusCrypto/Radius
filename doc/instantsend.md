...
This mechanism has been integrated into Bitcore-Node-Radius which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/radiuspay/insight-api-radius#web-socket-api](https://github.com/radiuspay/insight-api-radius#web-socket-api)
* API: [https://github.com/radiuspay/insight-api-radius#instantsend-transactions](https://github.com/radiuspay/insight-api-radius#instantsend-transactions)
...
By default, the Radius Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Radius Core daemon:
