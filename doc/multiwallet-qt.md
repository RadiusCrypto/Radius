...
Only requiring some minor changes is radius.cpp.
...
Changes to radius.cpp
----------------------
radius.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
