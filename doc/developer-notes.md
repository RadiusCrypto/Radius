...
Radius Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Radius Core, where everyone uses
...
pay attention to for reviewers of Radius Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Radius Core uses tinyformat, which is type safe. Leave them out to avoid confusion
