    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Radius Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Radius address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and radius: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Radius Core"), this);
    aboutAction->setStatusTip(tr("Show information about Radius Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Radius Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Radius addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Radius addresses"));
    ...
    openAction->setStatusTip(tr("Open a radius: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Radius Core help message to get a list with possible Radius Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Radius Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Radius network", "", count));
    } else {
...
{
    QString strTitle = tr("Radius Core"); // default title
