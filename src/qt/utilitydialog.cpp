    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Radius Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Radius Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  radius-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Radius in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RADIUS, 0.1 RADIUS, 1 RADIUS and 10 RADIUS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://radiuspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://radiuspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Radius Core is shutting down...") + "<br /><br />" +
