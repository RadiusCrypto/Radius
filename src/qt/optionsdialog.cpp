    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RADIUS-light"), QVariant("light"));
    ui->theme->addItem(QString("RADIUS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RADIUS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RADIUS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RADIUS-traditional"), QVariant("trad"));
