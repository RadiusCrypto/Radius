 ...
 *
 *   // network
 *   CRadiusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.radius.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRadiusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RadiusNetwork
// //   -- signature requirements : Key1(User)
// class CRadiusNetworkVariable : public CGovernanceObject
// {
// private:
