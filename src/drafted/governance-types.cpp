...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RadiusNetwork") type = RadiusNetwork;
    if(strType == "RadiusNetworkVariable") type = RadiusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RadiusNetwork) s = "RadiusNetwork";
    if(type == RadiusNetworkVariable) s = "RadiusNetworkVariable";
