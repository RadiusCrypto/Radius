...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Radius related functionality
...
/*
    ...
    allow endless transaction that would bloat Radius and make it unusable. To
